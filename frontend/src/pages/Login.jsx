...
export default function Login() {
  ...
  const fillDemo = () => { setEmail("alex@pullsync.dev"); setPassword("password123"); };
    ...
    <div className="min-h-screen bg-canvas flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm relative z-10 animate-fade-in">
        ...
        <div className="card p-6 shadow-2xl">
          ...
          <button onClick={fillDemo} className="w-full mt-2 btn-secondary text-center justify-center flex py-2">
            Use demo account
          </button>
        ...
        <p className="text-center text-xs text-fg-subtle mt-6">
          Demo: alex@pullsync.dev / password123
        </p>
      </div>
    </div>
  );
